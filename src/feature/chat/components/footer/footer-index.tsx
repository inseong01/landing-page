...
import type { MessageMetaData } from "../../util/const";
...
export default function ChatFooter({
  ...
  return (
    <div className="relative flex min-h-[54px] flex-col p-2">
      <div
        className={`flex justify-between gap-4 overflow-hidden rounded-[20px] border-[1px] border-[#ddd] p-1 ${!isOpponentOnline ? "cursor-not-allowed bg-[#f5f5f5]" : ""}`}
      >
        <input
          type="text"
          name="textInput"
          className="flex-1 bg-transparent pl-2 text-sm focus:outline-0 disabled:cursor-not-allowed"
        ...
        <button
          type="button"
          role="button"
          className="box-content flex items-center justify-center rounded-2xl bg-[#336cb5] p-1 pr-[12px] pl-[14px] text-white hover:bg-[#2a5896] not-disabled:hover:cursor-pointer disabled:cursor-not-allowed disabled:bg-[#757575]"
        ...
        >
          <img
            src="/feature/chat/icon-sent.svg"
            className="h-5 w-5"
            alt="전송"
          />
        </button>
