...
export default function ChatBody({
  ...
  return (
    <div
      className="bt-2 relative box-border h-full w-full overflow-auto p-4 pb-2"
      ref={chatRoomRef}
    >
      {/* 메시지 목록 */}
  ...
  return (
    <MessageBox writer={"other"}>
      <div className="flex items-center justify-center gap-[6px]">
        <CircleSpan animation={"animate-[pulse_1s_infinite_0ms]"} />
        <CircleSpan animation={"animate-[pulse_1s_infinite_100ms]"} />
        <CircleSpan animation={"animate-[pulse_1s_infinite_200ms]"} />
      </div>
    </MessageBox>
  );
}
