...
import PhoneDeviceView from "@/components/section/phone-device-view/section-index";
import MultiPhoneDevicesView from "@/components/section/multi-phone-device-view/section-index";
  ...
  return (
    <>
      <PhoneDeviceView
        ...
        src="/projects/qr-order//customer/phone-feature-1.png"
      ...
      <PhoneDeviceView
        ...
        src="/projects/qr-order//customer/short-order-process-resize.webp"
      ...
      <MultiPhoneDevicesView
        ...
        caution=""
        src_1="/projects/qr-order//customer/phone-category-1.png"
        src_2="/projects/qr-order//customer/phone-category-2.png"
        src_3="/projects/qr-order//customer/phone-category-3.png"
